angular.module('$selectBox', []).directive('selectBox', function () {
    return {
        ...
        template: '<input id="showed" type="text" ng-click="showSelectModal()" style="cursor:inherit;" readonly ng-required="true" />' + '<span id="hidden" type="text" style="display: none;"></span>',
