angular.module('ti-segmented-control', []
    ...
    return {
        ...
        controller: function($scope){
            ...
            style.type = 'text/css';
            style.innerHTML += '.button.button-outline.ti-segmented-control:first-child { border-top-left-radius: 0px;border-bottom-left-radius: 0px; }';
            style.innerHTML += '.button.button-outline.ti-segmented-control { line-height: 25px;max-height: 27px;min-height: 27px; }';
            style.innerHTML += '.button.button-outline.ti-segmented-control:last-child { border-top-right-radius: 0px; border-bottom-right-radius: 0px; }';
